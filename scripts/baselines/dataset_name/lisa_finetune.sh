...
for d_name in ${data_names[@]}; do
  ...
  lora_path=./saves/lora/sft/checkpoint-125
   ...
   python ./LLaMA_Factory/src/llamafactory/train/sft/lisa_train.py \
    ...
    --output_dir /media/1/yx/model_merging_v2/saves/lora/baselines/dataset_name/"${d_name}"-lisa-finetune-${dataset_selected} \
    --num_train_epochs 10 \
