...
for sparsity_ratio in ${sparsity_ratios[@]}; do
    ...
    for prune_rate in ${prune_rates[@]}; do
        ...
        python ./safe_lora/identify_realign.py \
             ...
             --output_path ./saves/lora/ablations/ratio_of_regions/adaptive_mask_replace-safe_lora/${dataset_name}-${alignment_type}-${dataset_selected}-${region_method}
